      ...
      <div className="flex items-center justify-between border-b border-border/50 px-8 py-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex h-9 items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-purple-500 px-4 text-sm font-semibold text-white shadow-lg shadow-purple-500/25 hover:from-purple-500 hover:to-purple-400 transition-all"
          >
            <svg
      ...
      <div className="p-8 pt-6">
        ...
        {!loading && !error && instances.length === 0 && (
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border/50 py-32">
            ...
            <button
              onClick={() => navigate("/create")}
              className="mt-8 inline-flex h-11 items-center gap-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-purple-500 px-6 text-sm font-semibold text-white shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:from-purple-500 hover:to-purple-400 transition-all duration-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
        ...
        {/* Instance grid with all instances */}
