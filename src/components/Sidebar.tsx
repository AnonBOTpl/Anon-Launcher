  ...
  return (
    <aside className="fixed left-0 top-0 z-50 flex h-full w-16 flex-col items-center border-r border-border/50 bg-sidebar-background/95 backdrop-blur-xl">
      ...
      <div className="flex h-16 w-full items-center justify-center">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 text-sm font-bold text-white shadow-lg shadow-purple-500/20">
          A
        </div>
      </div>
