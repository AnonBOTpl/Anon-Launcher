      ...
      return (
        <button
          ...
          className={cn(
            ...
            canLaunch
              ? "bg-gradient-to-r from-purple-600 to-purple-500 shadow-purple-500/25 hover:shadow-purple-500/40 hover:from-purple-500 hover:to-purple-400"
    ...
    case "launching":
      return (
        <button
          disabled
          className={cn(
            "inline-flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-purple-600/50 to-purple-500/50 px-6 text-sm font-semibold text-white/70 cursor-wait",
            isHero ? "h-11 px-6" : "h-9 px-4",
          )}
        >
      ...
      return (
        <div className="flex items-center gap-2">
          <button
            ...
            className={cn(
              "inline-flex items-center gap-2.5 rounded-xl font-semibold shadow-lg transition-all duration-200 active:scale-[0.97]",
              "bg-gradient-to-r from-purple-600 to-purple-500 text-white shadow-purple-500/25 hover:shadow-purple-500/40 hover:from-purple-500 hover:to-purple-400",
              isHero ? "h-11 px-6 text-sm" : "h-9 px-4 text-xs",
            )}
          >
            <svg
