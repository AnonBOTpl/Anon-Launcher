...
mod tests {
    ...
    fn test_sanitize_name() {
        assert_eq!(crate::sanitize::sanitize_name("My Instance 1"), "my_instance_1");
        assert_eq!(crate::sanitize::sanitize_name("Hello.World"), "hello_world");
        assert_eq!(crate::sanitize::sanitize_name("test"), "test");
    }
